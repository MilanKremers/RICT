...
namespace Company.Language1
{
	...
	/// </summary>
	public static partial class StructuralLayerReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Company.Language1.StructuralLayer)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Company.Language1.StructuralLayer)
				{
					if (candidateTarget is global::Company.Language1.StructuralLayer)
					{
						global::Company.Language1.StructuralLayer sourceStructuralLayer = (global::Company.Language1.StructuralLayer)candidateSource;
						global::Company.Language1.StructuralLayer targetStructuralLayer = (global::Company.Language1.StructuralLayer)candidateTarget;
						if(targetStructuralLayer == null || sourceStructuralLayer == null || global::Company.Language1.StructuralLayerReferencesTargets.GetLinks(sourceStructuralLayer, targetStructuralLayer).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Company.Language1.StructuralLayer)
				{
					if (target is global::Company.Language1.StructuralLayer)
					{
						global::Company.Language1.StructuralLayer sourceAccepted = (global::Company.Language1.StructuralLayer)source;
						global::Company.Language1.StructuralLayer targetAccepted = (global::Company.Language1.StructuralLayer)target;
						DslModeling::ElementLink result = new global::Company.Language1.StructuralLayerReferencesTargets(sourceAccepted, targetAccepted);
	...
	internal partial class ExampleRelationshipConnectAction : DslDiagrams::ConnectAction
	{
		...
		private partial class ExampleRelationshipConnectionTypeBase : DslDiagrams::ConnectionType
		{
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder StructuralLayerReferencesTargetsBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return StructuralLayerReferencesTargetsBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return StructuralLayerReferencesTargetsBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				StructuralLayerReferencesTargetsBuilder.Connect(sourceElement, targetElement);
			}
		}
