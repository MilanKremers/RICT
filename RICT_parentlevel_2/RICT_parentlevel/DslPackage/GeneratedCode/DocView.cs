...
namespace Company.RICT_parentlevel
{
	...
	/// </summary>
	internal partial class RICT_parentlevelDocView : RICT_parentlevelDocViewBase
	{
		/// <summary>
		/// Constructs a new RICT_parentlevelDocView.
		/// </summary>
		public RICT_parentlevelDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class RICT_parentlevelDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new RICT_parentlevelDocView.
		/// </summary>
		protected RICT_parentlevelDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			RICT_parentlevelDocDataBase docData = this.DocData as RICT_parentlevelDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for RICT_parentlevelDocViewBase should be an RICT_parentlevelDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.RICT_parentlevel.RICT_parentlevelDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.RICT_parentlevel.RICT_parentlevelDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.RICT_parentlevel.RICT_parentlevelToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.RICT_parentlevel.RICT_parentlevelToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.RICT_parentlevelDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.RICT_parentlevel.RICT_parentlevelHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.RICT_parentlevel.RICT_parentlevelHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.RICT_parentlevel.RICT_parentlevelHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
