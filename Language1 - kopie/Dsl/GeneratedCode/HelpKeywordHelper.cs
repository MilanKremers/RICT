...
namespace Company.Language1
{
	...
	/// </remarks>
	public partial class Language1HelpKeywordHelper : Language1HelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new Language1HelpKeywordHelper.
		/// </summary>
		protected Language1HelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the Language1HelpKeywordHelper.
		/// </summary>
		public static Language1HelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class Language1HelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new Language1HelpKeywordHelperBase.
		/// </summary>
		protected Language1HelpKeywordHelperBase()
			: base() { }
