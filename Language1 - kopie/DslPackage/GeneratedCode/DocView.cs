...
namespace Company.Language1
{
	...
	/// </summary>
	internal partial class Language1DocView : Language1DocViewBase
	{
		/// <summary>
		/// Constructs a new Language1DocView.
		/// </summary>
		public Language1DocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class Language1DocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new Language1DocView.
		/// </summary>
		protected Language1DocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			Language1DocDataBase docData = this.DocData as Language1DocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for Language1DocViewBase should be an Language1DocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.Language1.Language1Diagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.Language1.Language1Diagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.Language1.Language1ToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.Language1.Language1ToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.Language1DiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.Language1.Language1HelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.Language1.Language1HelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.Language1.Language1HelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
