...
namespace Company.RICT_parentlevel
{
	...
	/// </remarks>
	public partial class RICT_parentlevelHelpKeywordHelper : RICT_parentlevelHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new RICT_parentlevelHelpKeywordHelper.
		/// </summary>
		protected RICT_parentlevelHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the RICT_parentlevelHelpKeywordHelper.
		/// </summary>
		public static RICT_parentlevelHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class RICT_parentlevelHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new RICT_parentlevelHelpKeywordHelperBase.
		/// </summary>
		protected RICT_parentlevelHelpKeywordHelperBase()
			: base() { }
