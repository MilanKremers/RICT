...
namespace Company.Language1
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.Language1EditorFactoryId)]
	internal partial class Language1EditorFactory : Language1EditorFactoryBase
	{
		/// <summary>
		/// Constructs a new Language1EditorFactory.
		/// </summary>
		public Language1EditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class Language1EditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected Language1EditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new Language1DocData(this.ServiceProvider, typeof(Language1EditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new Language1DocView(docData, this.ServiceProvider);
		}
	}
}
