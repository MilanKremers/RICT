...
namespace Company.Language1
{
	...
	/// </remarks>
	public partial class Language1ToolboxHelper : Language1ToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new Language1ToolboxHelper.
		/// </summary>
		public Language1ToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class Language1ToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify Language1 toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "Language1.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new Language1ToolboxHelperBase.
		/// </summary>
		protected Language1ToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.Language1.Language1DomainModel.SingletonResourceManager.GetString("Language1ToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Company.Language1.Language1DomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Company.Language1.StructuralToolToolboxItem":
					// Add StructuralTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.Language1.StructuralToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						1, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("StructuralToolToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("StructuralToolToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Company.Language1.Language1ToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("Language1ToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"CreateExampleClassF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("StructuralToolToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Company.Language1.StructuralLayer.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.Language1.ExampleRelationshipToolboxItem":

					// Add ExampleRelationship connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.Language1.ExampleRelationshipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "Company.Language1.EnablingToolToolboxItem":
					// Add EnablingTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.Language1.EnablingToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						3, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("EnablingToolToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("EnablingToolToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Company.Language1.Language1ToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("Language1ToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"EnablingTool", // F1 help keyword for the toolbox item.
						resourceManager.GetString("EnablingToolToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Company.Language1.EnablingLayer.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.Language1.LifeCycleToolToolboxItem":
					// Add LifeCycleTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.Language1.LifeCycleToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						4, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("LifeCycleToolToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("LifeCycleToolToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Company.Language1.Language1ToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("Language1ToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"LifeCycleTool", // F1 help keyword for the toolbox item.
						resourceManager.GetString("LifeCycleToolToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Company.Language1.LyfeCycleLayer.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.Language1.SystemToolToolboxItem":
					// Add SystemTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.Language1.SystemToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						5, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("SystemToolToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("SystemToolToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Company.Language1.Language1ToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("Language1ToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"SystemTool", // F1 help keyword for the toolbox item.
						resourceManager.GetString("SystemToolToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Company.Language1.SystemLayer.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.Language1.Language1DomainModel));
