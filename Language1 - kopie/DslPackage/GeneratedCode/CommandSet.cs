...
namespace Company.Language1
{
	...
	/// </summary>
	internal partial class Language1CommandSet : Language1CommandSetBase
	{
		/// <summary>
		/// Constructs a new Language1CommandSet.
		/// </summary>
		public Language1CommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class Language1CommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new Language1CommandSetBase.
		/// </summary>
		protected Language1CommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewLanguage1ExplorerCommand,
				typeof(Language1EditorFactory).GUID);
		...
		{
			Language1ExplorerToolWindow explorer = this.Language1ExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected Language1DocData CurrentLanguage1DocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as Language1DocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected Language1DocView CurrentLanguage1DocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as Language1DocView;
			}
		}
		...
		/// </summary>
		protected Language1ExplorerToolWindow Language1ExplorerToolWindow
		{
			get
			{
				Language1ExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(Language1ExplorerToolWindow), true) as Language1ExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				Language1ExplorerToolWindow explorerWindow = this.Language1ExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class Language1ClipboardCommandSet : Language1ClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new Language1ClipboardCommandSet.
		/// </summary>
		public Language1ClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class Language1ClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new Language1ClipboardCommandSetBase.
		/// </summary>
		protected Language1ClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
